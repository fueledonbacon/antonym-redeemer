<template>
  <main class="page flex flex-col items-center text-center">
    <div class="max-w-2xl my-auto">
      <div
        class="text-3xl my-8 md:text-4xl lg:text-5xl xl:text-6xl text-black font-medium uppercase"
      >
      ...
      >
        ...
        <div class="grid >xs:grid-rows-3 sm:grid-cols-3 gap-4 my-8 font-bold text-base sm:text-[10px] lg:text-[12px] xl:text-[14px] 2xl:text-[16px] w-full max-w-[34rem]">
          <div>
            <h4>Wave 1</h4>
            <p>July 11-20, 2022</p>
          </div>
