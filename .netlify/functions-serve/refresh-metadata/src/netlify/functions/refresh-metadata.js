...
// netlify/functions/refresh-metadata.mjs
var refresh_metadata_exports = {};
__export(refresh_metadata_exports, {
  handler: () => handler
});
...
var handler = async (event, context) => {
  try {
    ...
    const data = await (0, import_axios.post)(`https://${isTestnet ? "testnets-" : ""}api.opensea.io/api/v1/asset/${contractAddress}/${tokenID}/?force_update=true`);
    return {
      statusCode: 200,
...
module.exports = __toCommonJS(refresh_metadata_exports);
 ...
 * MIT Licensed
 */
//# sourceMappingURL=refresh-metadata.js.map
